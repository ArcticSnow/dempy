...
def saveArray2rasterTif(fname, array, rasterOrigin, pixelWidth, pixelHeight, _FillValue,OutPath=None):
    '''
    ...
    **OutPath** : optional. String indicating the path where to save the file \n
    ...
    outRaster.SetGeoTransform(np.double([rasterOrigin[0],pixelWidth,0,rasterOrigin[1],0,pixelHeight]))
